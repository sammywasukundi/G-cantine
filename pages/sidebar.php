...
<body>
  ...
  <aside id="default-sidebar"
    ...
    <form method="post" class="flex items-center max-w-sm mx-auto p-4">
      ...
      <button name="submit_search" type="submit"
        class="p-2.5 ms-2 text-sm font-medium text-white bg-green-400 rounded-lg border border-green-400 hover:bg-green-600">
      ...
      <ul class="space-y-2">
        ...
        <li>
          <a href="eventaire.php"
            ...
            <span class="ml-3">Eventaire</span>
          </a>
        </li>
        <li>
          <a href="etat_besoin.php"
            ...
            <span class="ml-3">Etat de besoin</span>
          </a>
        </li>
        <li>
          <button type="button"
            ...
            <span class="flex-1 ml-3 text-left whitespace-nowrap">Ajouter</span>
        ...
        <li>
          <button type="button"
            ...
            <span class="flex-1 ml-3 text-left whitespace-nowrap">Authentification</span>
            <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
    ...
    <div
      class="absolute bottom-6 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-gray-800 z-20 border-r border-gray-200 dark:border-gray-700">
      <a href="#" data-tooltip-target="tooltip-settings"
        class="inline-flex justify-center p-2 bottom-3 text-gray-500 rounded cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600">
      ...
      <div id="tooltip-settings" role="tooltip"
        class="inline-block absolute invisible z-10 py-3 px-4 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip">
        Déconnexion
        <div class="tooltip-arrow" data-popper-arrow></div>
      </div>
      <div class="inline-flex justify-center mt-2">
        <img class="w-8 h-8 rounded-full object-fit" src="../assets/vectors/person.png" alt="">
        <span
          class="top-0 left-7 w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"></span>
      </div>
