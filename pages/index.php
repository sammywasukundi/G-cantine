        ...
        <div class="flex min-h-screen items-center justify-center text-2xl font-bold h-48 mb-4 rounded">
            <div class="block items-center justify-center space-y-3">
                ...
                <p class="text-xl font-semibold text-center text-gray-800 sm:text-xl md:text-2xl lg:text-3xl">
                    Suivez toutes les opérations de votre boutique
                </p>
            </div>
        </div>
        <div class="flex items-center justify-center h-12 rounded">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
            ...
            <div style="
              box-shadow: rgba(17, 17, 26, 0.1) 0px 8px 24px,
                ...
                rgba(17, 17, 26, 0.1) 0px 24px 80px;
            "
                class="flex items-center justify-center h-48 rounded bg-blue-50 hover:bg-blue-100 hover:text-blue-900 ease-in duration-300 hover:text-gray-100">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-12 h-12 md:w-8 md:h-8 lg:w-10 lg:h-10 hidden md:block me-2">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div style="
              box-shadow: rgba(17, 17, 26, 0.1) 0px 8px 24px,
                ...
                rgba(17, 17, 26, 0.1) 0px 24px 80px;
            "
                class="flex items-center justify-center h-48 rounded bg-green-50 hover:bg-green-100 hover:text-green-850">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-12 h-12 md:w-8 md:h-8 lg:w-10 lg:h-10 hidden md:block me-2">
                    <path stroke-linecap="round" stroke-linejoin="round"
