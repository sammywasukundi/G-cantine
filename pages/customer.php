...
include '../model/class_client.php';
$DB = new DB();
?>
...
if (isset($_POST['submit_customer'])) {
    ...
    $numero_tel_client = $_POST['numero_tel_client'];

    // Instanciation de la classe Client avec les données du formulaire
    $client = new Client(null, $nom_client, $adresse_client,$numero_tel_client);

    // Appel de la méthode pour enregistrer le client
    $client->save_client();
}